...
// new Sequelize(process.env.DB_NAME, process.env.DB_USER, process.env.DB_PW, { ... }): If the JAWSDB_URL does not exist, the Sequelize 
// instance is created with the connection parameters from the.env file.The values for DB_NAME, DB_USER, and DB_PW are retrieved from the
// process.env object, representing the database name, username, and password, respectively.The connection options(host, dialect, and dialectOptions) 
// are also provided.

// Export Sequelize Instance:

// module.exports = sequelize;: This line exports the created Sequelize instance, making it available for use in other parts of the application. 
// By exporting the instance, other modules can use it to define models, perform database queries, and manage the database operations.
